...
GO
ALTER DATABASE DemoDB ADD FILE (NAME = F0000, FILENAME = 'D:\F0000.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG0000;
GO
ALTER DATABASE DemoDB ADD FILEGROUP FG2000
GO
ALTER DATABASE DemoDB ADD FILE (NAME = F2000, FILENAME = 'D:\F2000.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG2000;
GO
ALTER DATABASE DemoDB ADD FILEGROUP FG2001
GO
ALTER DATABASE DemoDB ADD FILE (NAME = F2001, FILENAME = 'D:\F2001.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG2001;
GO
ALTER DATABASE DemoDB ADD FILEGROUP FG2002
GO
ALTER DATABASE DemoDB ADD FILE (NAME = F2002, FILENAME = 'D:\F2002.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG2002;
GO
ALTER DATABASE DemoDB ADD FILEGROUP FG2003
GO
ALTER DATABASE DemoDB ADD FILE (NAME = F2003, FILENAME = 'D:\F2003.ndf', SIZE = 3MB, FILEGROWTH = 50%) TO FILEGROUP FG2002;
GO
...
INSERT order_table VALUES (20000101, 100);
INSERT order_table VALUES (20001231, 100);
INSERT order_table VALUES (20010101, 100);
INSERT order_table VALUES (20010403, 100);
GO
...
CREATE TABLE archive_staging_table
 (datekey int, amount int)
ON FG0000;
GO
...
ALTER TABLE order_table SWITCH PARTITION $PARTITION.PF(20000101)
TO archive_staging_table 
GO

-- view archive data
SELECT * FROM archive_staging_table;
